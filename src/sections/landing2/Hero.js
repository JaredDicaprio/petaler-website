          ...
          <Row>
            ...
            >
              <Box py={[null, null, null, 5]} pr={5} pt={[4, null]}>
                ...
                <Text mb={4}>
                  However, more consumers want to enjoy flowers grown closer to
                  home 🏠 - both to support businesses they care about and
                ...
                <Text mb={4}>
                  ...
                  matters because it encourages stronger communities through the
                  shared joy of flowers. 💐
                </Text>
                <form action="/">
